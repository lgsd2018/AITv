export default {
  ...
  workflow: {
    ...
    extractCharactersAndScenes: 'Extract Characters, Scenes and Props',
    reExtract: 'Re-extract Characters, Scenes and Props',
    nextStepGenerateImages: 'Next Step: Generate Images',
    extractWarning: 'Please click "Extract Characters, Scenes and Props" first, then you can generate images after extraction is complete',
    characterImages: 'Character Images',
    ...
    propCount: '{count} props need to generate images',
    selectAll: 'Select All',
    batchGenerate: 'Batch Generate',
    ...
    batchGenerateProps: 'Batch Generate Selected Props',
    generateAllImagesFirst: 'Please generate all character, scene, and prop images before splitting shots',
